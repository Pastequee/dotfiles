---
name: xp-simplicity
simplicity rules checker. Runs automatically on Stop to review changes against the four simplicity rules. Checks that code passes tests, expresses every needed idea, says everything once and only once, and has no superfluous parts.
model: haiku
---
